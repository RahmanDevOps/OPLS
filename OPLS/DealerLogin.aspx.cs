...
namespace OPLS
{
    public partial class DealerLogin : System.Web.UI.Page
    {
        ...
        {
            sqlcon.Open();
            string namel = ("select Boolean from DealerRegister where RID = '" + TextBox1.Text + "' ");
        ...
        private void ValidateUsercs(string p, string p_2)
        {
            ...
            SqlCommand sqlcmd = new SqlCommand("select * from DealerRegister where RID=@id and Password=@USERPWD", sqlcon);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Response.Redirect("DealerHome.aspx");

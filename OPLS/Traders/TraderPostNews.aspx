<%@ Page Title="" Language="C#" MasterPageFile="~/TraderMaster.Master" AutoEventWireup="true" CodeBehind="TraderPostNews.aspx.cs" Inherits="OPLS.Traders.TraderPostNews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="headings" 
        ...
        <br />
         ...
         <asp:Button ID="Button1" runat="server" Text="Post Notice" ForeColor="Black" 
     ...
     &nbsp; &nbsp;&nbsp;
            <asp:Button ID="Button3" runat="server" Text="View Posted Notice" ForeColor="Black" 
            Font-Size="Large" Font-Bold="True" Height="30px" Width="185px" 
                onclick="Button3_Click" PostBackUrl="~/Traders/PostedNews.aspx" />

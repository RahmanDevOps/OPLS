<%@ Page Title="" Language="C#" MasterPageFile="~/Dealer.Master" AutoEventWireup="true" CodeBehind="PostItems.aspx.cs" Inherits="OPLS.Dealers.PostItems" %>
    ...
    <tr>
        ...
        <td>
            <asp:Button ID="Button1" runat="server" Font-Bold="True" Height="30px" 
                onclick="Button1_Click" Text="Post Item" Width="120px" /> &nbsp; &nbsp;&nbsp;&nbsp;

            <asp:Button ID="Button2" runat="server" Font-Bold="True" Height="30px" Text="Reset" 
                Width="120px" />
        </td>
        <td>
            &nbsp;</td>

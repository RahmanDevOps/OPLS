<%@ Page Title="" Language="C#" MasterPageFile="~/people.Master" AutoEventWireup="true" CodeBehind="peoplehome.aspx.cs" Inherits="OPLS.Peoples.peoplehome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="headings" 
        ...
        style="border: 0px inset #FFFFCC; width: 29%; height: 300px; float: left;">
              ...
              <br />
             &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
              <asp:Image ID="Image1" runat="server" Width="145px" Height="190px" 
         ...
         <div class="content" style="border: 0px inset #FFFFCC; width: 69%; height: 360px; float: right;">
                 ...
                 <tr>
                     <td style="color: #FFFFCC; font-family: Arial, Helvetica, sans-serif; font-size: small; font-weight: bold; font-style: normal; font-variant: normal; text-transform: none" 
                         ...
                         <asp:Button ID="Button2" runat="server" Font-Bold="True" Height="28px" 
                                            Text="Update Profile" Width="180px" onclick="Button2_Click" 
                             PostBackUrl="~/Dealers/UpdateProfile.aspx"/>
                     </td>
                     <td style="font-family: Arial, Helvetica, sans-serif; font-size: small; font-weight: bold; font-style: normal; font-variant: normal; text-transform: none; color: #FFFFCC">
                         <asp:Button ID="Button3" runat="server" Font-Bold="True" Height="28px" 
                    Text="Change Password" Width="180px" onclick="Button3_Click"/>
                     </td>
                 </tr>
             </table>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyTraders.aspx.cs" Inherits="OPLS.Admin.VerifyTraders" %>
        ...
        <ItemTemplate>
         ...
         <div class="" style="width:50%;float:left; font-family: 'Bodoni MT'; font-size: medium; font-weight: bold; font-style: normal; font-variant: normal; text-transform: none; color: #FFFFCC;">
          &nbsp;&nbsp;  Name:&nbsp;<%#Eval("Name") %><br />&nbsp;&nbsp;  
                        ...
                        Mobile No :&nbsp;<%#Eval("Mob") %><br /><a href="veirfy.aspx?id=<%#Eval("ID") %>">Verify Now </a>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DealerControl.aspx.cs" Inherits="OPLS.Admin.DealerControl" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Button ID="Button1" runat="server" Text="View & Delete Dealers" 
    ...
    <asp:Button ID="Button2" runat="server" Text="Verify Dealers" 
    Height="35" CssClass="OneButton3"  Width="270px" 
